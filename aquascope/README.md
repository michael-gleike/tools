...
## Visualisierung
Aquascope stellt einen [mdBook](https://rust-lang.github.io/mdBook/) Präprocessor dar der Aquascope-Diagramme in ein mdBook integriert.
...
1. Blockannotationen
   ...
   |:-------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
   | aquascope    | Mit dieser Annotation aktiviert man den Aquascope Preprozessor auf dem Codeblock                                                                                                                                                                                                       |
   ...
   | boundaries   | Mit dieser Annotation aktiviert man das Anzeigen der erwarteten Berechtigungn ![expectRead.png](pictures/notation/expectRead.png),![expectWrite.png](pictures/notation/expectWrite.png), ![expectOwner.png](pictures/notation/expectOwner.png). Benötigt die Annotation `permissions`. |
   | shouldFail   | Mit dieser Annotation können Codeblöcke mit dem `interpreter` verarbeitet werden, die nich kompilierbar sind.                                                                                                                                                                          |
...
## Evaluierung
1. Vorteile
    - Playground: Die Visualisierung findet automatisch statt. Dabei muss man über kein Wissen zu Annotation verfügen und kann den eigenen Code per copy und paste evaluieren lassen.
